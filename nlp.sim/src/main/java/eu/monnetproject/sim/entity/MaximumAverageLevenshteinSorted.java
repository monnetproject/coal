...
/**
 * Levenshtein similarity after sorting the labels. For cases like "Assets,
 * current" vs. "Current assets" Intralingual aggregation: average Interlingual
 * aggregation: maximum
 *
 * @author Dennis Spohr
 *
...
public class MaximumAverageLevenshteinSorted implements EntitySimilarityMeasure {
    ...
    public MaximumAverageLevenshteinSorted(LabelExtractorFactory lef) {
        this.lef = lef;
